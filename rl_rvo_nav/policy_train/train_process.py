...
model_path = cur_path / 'model_save' / ('r' + str(robot_num) )

figure_path = model_path / 'figure'
ani_path = model_path / 'ani'
...
par_env.add_argument('--robot_number', type=int, default=robot_num)
...
par_policy.add_argument('--policy_mode', default='rnn') 
...
par_train.add_argument('--train_epoch', type=int, default=200)
...
par_train.add_argument('--save_path', default=str(model_path))
par_train.add_argument('--save_name', default= ('/r' + str(robot_num)) )
...
model_path_check = args.save_path + '_{}'
model_name_check = args.save_name + '_{}'
...
test_env = gym.make(args.env_name, world_name=args.world_path, robot_number=args.robot_number, neighbors_region=args.neighbors_region, neighbors_num=args.neighbors_num, robot_init_mode=args.init_mode, env_train=False, random_bear=args.random_bear, random_radius=args.random_radius, reward_parameter=args.reward_parameter, plot=False, obs_mode=args.obs_mode, reward_mode=args.reward_mode, full=args.full)
