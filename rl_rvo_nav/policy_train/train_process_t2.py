...
from drl_rvo_nav.policy_train.multi_ppo import multi_ppo
from drl_rvo_nav.policy.policy_rnn_ac import rnn_ac
from drl_rvo_nav.policy.policy_transformer_ac import transformer_ac
...
load_name = '/r4_0'
load_fname = str(cur_path.parent/ 'policy_test'/'model_save') + load_name + load_name + '_check_point_450.pt'
...
par_env.add_argument('--env_name', default='mrnav-v0')
